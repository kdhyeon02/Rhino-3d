...
def jsonToRhinoCommon(jsonFeature):
        ...
        elevation = jsonFeature['properties']['ELEVATION']
        height = jsonFeature['properties']['A16']
        ...
        # translate the coordinates to Rhino.Geometry objects
            ...
            rhFeature = geoJsonGeometryMap[geomType][elevation](coordinates, height, elevation)
        return rhFeature
